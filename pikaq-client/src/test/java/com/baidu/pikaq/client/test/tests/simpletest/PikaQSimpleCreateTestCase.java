 ...
 */
public class PikaQSimpleCreateTestCase extends BaseTestCaseNoRollback {

    protected static final Logger LOGGER = LoggerFactory.getLogger(PikaQSimpleCreateTestCase.class);
