...
public final class PrivateMethodUtil {
     ...
     * @param parameters 私有方法参数
     *
     * @return 私有方法返回值
     */
    public static Object invokeMethod(final Object owner, final String methodName, final Object... parameters)
        throws Exception {
     ...
     * @param owner          注入的对象
     * @param methodName     私有方法名
     * @param parameterTypes 私有方法参数类型
     * @param parameters     私有方法参数
     *
     * @return 私有方法返回值
     */
    public static Object invokeMethod(final Object owner, final String methodName, final Class[] parameterTypes,
        ...
        try {
            ...
            final Method getTargetClass = ownerclass.getMethod("getTargetSource");
     ...
     */
    public static Object invokeMethod(final Object owner, final int classLevel, final String methodName,
        ...
        final Method method = ownerclass.getDeclaredMethod(methodName, parameterTypes);
        if (!method.isAccessible()) {
            method.setAccessible(true);
        }
     ...
     */
    public static void setObjectProperty(final Object owner, final int classLevel, final String fieldName,
     ...
     */
    public static Object getObjectProperty(final Object owner, final int classLevel, final String fieldName)
        throws Exception {
        // get class
        final Class ownerclass = getOwnerclass(owner, classLevel);
